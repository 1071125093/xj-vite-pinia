<!--
 * @Author: XiaoJun
 * @Date: 2022-07-12 19:12:15
 * @LastEditors: XiaoJun
 * @LastEditTime: 2022-07-12 19:12:16
 * @Description: 组件功能
 * @FilePath: /xj-vite-pinia/src/views/front/reborn/components/shard21/components/d3Line copy.vue
-->
<!--
 * @Author: llh
 ...
 * @LastEditors: XiaoJun
 * @Description: 文件描述
 * @FilePath: /pub-op-ctrl-sys/src/views/guidePage/page9/components/D3Line/D3Line.vue
-->
<template>
  <div class="D3Line">
    <svg ref="svgDom" :id="`svgDom_${domId}`">
      <defs>
        <linearGradient id="linear">
          ...
          <stop offset="50%" style="stop-color: #7bfaff" stop-opacity="1" />
          <stop offset="100%" style="stop-color: #7bfaff" stop-opacity=".2" />
        </linearGradient>
        <mask id="Mask"></mask>
  ...
  setup(props) {
    ...
    const startAnimate = () => {
      ...
      if (props.randomFlash) {
        timer = setInterval(animate, parseInt(Math.random() * (10e3 - 5e3 + 1) + 5e3))
      } else {
